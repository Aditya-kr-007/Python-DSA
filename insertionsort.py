...
def sortArray(nums):
        ...
        for i in range(1,n):
            ...
            #while j is greater than or equal to 0 and the element at index j is greater than key, shift the element at index j to the right by one position and decrement j by 1
